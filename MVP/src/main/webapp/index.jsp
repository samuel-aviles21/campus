...
<body>
            ...
            <nav class="navbar navbar-expand-lg">
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                  <a href="registrarse.html">
                    <button class="btn btn-outline-light btn-white" type="button">Registrarse</button>
                  </a>
                  <a href="iniciarsesion.html">
                    <button class="btn btn-outline-light btn-white" type="button">Iniciar sesion</button>
                  </a>
                </div>
            </nav>
        </div>
  ...
  <div id="busqueda">
      <div class="logo">
          ...
          <img src="images/logoazul.png" class="ajustar-imagen">
      </div>
